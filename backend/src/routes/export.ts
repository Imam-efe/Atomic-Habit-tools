...
const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  agent_actions: ['id', 'user_id', 'tool', 'module', 'message', 'args_json', 'row_ids_json', 'undo_meta_json', 'summary', 'status', 'created_at', 'undone_at'],
  cooking_recipes: ['id', 'user_id', 'name', 'have_json', 'missing_json', 'steps_json', 'minutes', 'servings', 'note', 'last_cooked_date', 'cooked_count', 'created_at'],
