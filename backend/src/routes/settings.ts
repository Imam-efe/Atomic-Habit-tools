...
export const DATA_TABLES: Array<{ table: string; label: string; group: string; userScoped: boolean }> = [
  ...
  { table: 'garden_bed_markers', label: 'Penanda denah bedengan', group: 'Kebun', userScoped: true },
  { table: 'garden_compost_batches', label: 'Batch kompos', group: 'Kebun', userScoped: true },
