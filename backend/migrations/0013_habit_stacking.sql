...
CREATE TABLE IF NOT EXISTS habit_stack_items (
  id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_habit_stack_items_stack ON habit_stack_items(stack_id);
CREATE INDEX IF NOT EXISTS idx_habit_stack_items_habit ON habit_stack_items(habit_id);
